...
# HIHG AVIABILITY AND FAILOVER
# MEMBERS CAN HACE DIFERENTS ROLES AND SPECIFIC PURPOUSES
# PRIMARY
# SECONDARY
# HIDDEN -> ONLY READ OPERATION, NOT ALLOWED TO BE PRIMARY
# ARBITRARY-> NO DATA, NOT ALLOWED TO BE PRIMARY, ONLY FOR VOTES PURPOSES
# DELAYED-> 1 HOUR OF DELAY TO RECOVER ACCIDENTALLY DELETED
